...
[![x-cmd/install — coredns Code Quality Monitoring Repo Card](https://repo.x-cmd.io/coredns.svg?lang=zh)](https://x-cmd.com/install/coredns)
...
合计: **91,243** 行代码（覆盖前 5 种语言、共 **750** 个文件）。

| 语言 | 代码 | 注释 | 空行 | 文件数 |
|------|-----:|-----:|-----:|------:|
| Go | 91,077 | 6,799 | 12,713 | 738 |
...
- **Star**: 14,335 · **Fork**: 2,531 · **开放 issue**: 2,535 · **贡献者**: 479

## 累计统计

- **发布数**: 85 · **已合并 PR**: 4614 · **开放 PR**: 77 · **已关闭 issue**: 2336 · **开放 issue**: 199 · **提交数**: 5116

## 最近活动

| 时间窗口 | 起始 | 发布 | 已合并 PR | 开放 PR | 已关闭 issue | 开放 issue | 提交 |
|---|---|---:|---:|---:|---:|---:|---:|
| 30d | 2026-08-23 | 0 | 71 | 16 | 3 | 3 | 61 |
| last60d | 2026-07-24 | 1 | 157 | 32 | 6 | 8 | 163 |
| 90d | 2026-06-24 | 3 | 270 | 36 | 16 | 9 | 274 |
| last180d | 2026-03-26 | 5 | 436 | 44 | 34 | 15 | 427 |
| 360d | 2025-09-27 | 11 | 738 | 49 | 68 | 29 | 728 |
| last720d | 2024-10-02 | 17 | 1109 | 60 | 125 | 89 | 1124 |
...
- **编辑包条目**: <https://github.com/x-cmd/install/edit/main/coredns.yml>（或索引实际使用的路径）

本页面的数据（card / loc / scorecard / release）由 [x-cmd-install-action](https://github.com/x-cmd-install/x-cmd-install-action) 自动采集，每日重新生成。**安装行为**（版本选择、平台差异、依赖处理）的改进应提交到上游索引。

_数据快照: `data/card/260922.yml` · 2026-09-22T05:17:29Z._
